...
$$M_1 = \overline{X}, \quad M_2 = \frac{1}{n}\sum X_i^2, \dots, M_k = \frac{1}{n} \sum X_i^k$$
...
$$\begin{cases} E[X] = M_1 \\ E[X^2] = M_2 \\ \vdots \\ E[X^k] = M_k \end{cases}$$
